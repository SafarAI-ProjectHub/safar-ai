        ...
        <div class="main-body">
            <div class="row">
                            ...
                            <div class="d-flex flex-column align-items-center text-center">
                                <form id="profileForm" method="POST" action="<?php echo e(route('profile.update')); ?>"
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <p class="text-secondary mb-1">Position: <?php echo e(Auth::user()->role->role_name); ?></p>
                                        <p class="text-muted font-size-sm">Country: <?php echo e(Auth::user()->country_location); ?></p>
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <form id="profile-update-form" action="<?php echo e(route('profile.update')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('put'); ?>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="country_location"
                                            class="form-control <?php $__errorArgs = ['country_location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('country_location', Auth::user()->country_location)); ?> "
                                            disabled />
                                        <input type="hidden" name="country_location"
                                            value="<?php echo e(old('country_location', Auth::user()->country_location)); ?>" />
                                        <?php $__errorArgs = ['country_location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/profile/edit.blade.php ENDPATH**/ ?>