    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#quiz-results-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('quizResults.index')); ?>',
                    data: function(d) {
            ...
            $('#course-filter').on('change', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('units.byCourse')); ?>',
                    method: 'GET',
                    data: {
                        course_id: courseId
                    },
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/dashboard/quiz/quizzes_attempts.blade.php ENDPATH**/ ?>