<?php $__env->startSection('styles'); ?>
    <style>
        ...
        .certificate:after {
            content: '';
            position: absolute;
            background: url('<?php echo e(asset('img/corner.png')); ?>') no-repeat;
        ...
        <div class="certificate-wrapper frame">
            <div class="certificate">
                <div class="certificate__header">
                    <img src="<?php echo e(asset('assets/images/logo-img.png')); ?>" alt="Safar AI Academy Logo" class="certificate__logo">
                ...
                <div class="certificate__footer">
                    <div class="certificate__date entry-column">
                        <span class="entry-column__input"><?php echo e(\Carbon\Carbon::parse($completedAt)->format('F j, Y')); ?></span>
    ...
    <script>
        $(document).ready(function() {
            $('#download-certificate').click(function(e) {
                ...
                var form = $('#ssn-form');
                $.ajax({
    url: '<?php echo e(route('certificate.generatePDF')); ?>',
    type: 'POST',
    data: form.serialize(),
    headers: {
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/dashboard/student/certificate.blade.php ENDPATH**/ ?>