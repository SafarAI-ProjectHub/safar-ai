    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#payments-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('admin.payments')); ?>',
                    data: function(d) {
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/dashboard/admin/subscriptions/payments.blade.php ENDPATH**/ ?>