    ...
    <script>
        $(document).ready(function() {
            var table = $('#offers-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('offers.index')); ?>',
                columns: [{
                        data: 'name',
                        name: 'name'
                    },
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/dashboard/admin/offers.blade.php ENDPATH**/ ?>