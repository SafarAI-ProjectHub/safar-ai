...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-body table-responsive">
            <h5>Manage Create Unit Permissions</h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#permissions-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('manage.permissions')); ?>',
                    data: function(d) {
        ...
        function updatePermission(userId, permissionId, action) {
            $.ajax({
                url: '<?php echo e(route('manage.permissions.update')); ?>',
                method: 'POST',
                data: {
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/dashboard/admin/teacher_permission.blade.php ENDPATH**/ ?>