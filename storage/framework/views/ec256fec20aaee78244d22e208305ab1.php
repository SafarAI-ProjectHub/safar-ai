                                ...
                                <div id="step1" role="tabpanel" class="bs-stepper-pane"
                                        ...
                                        <select class="form-select" id="course-select" disabled>
                                            ...
                                            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($course->id); ?>"
                                                    <?php echo e($course->id == $quiz->unit->course->id ? 'selected' : ''); ?>>
                                    ...
                                    <div class="mb-3" id="units-container">
                                        ...
                                        <select class="form-select" id="unit-select" disabled>
                                            ...
                                            <?php $__currentLoopData = $quiz->unit->course->units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($unit->id); ?>"
                                                    <?php echo e($unit->id == $quiz->unit->id ? 'selected' : ''); ?>>
                                ...
                                <div id="step2" role="tabpanel" class="bs-stepper-pane"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="quiz-title" name="title"
                                            value="<?php echo e($quiz->title); ?>" required>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editQuizForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('quiz.updateQuiz', ['quizId' => $quiz->id])); ?>',
                    method: 'POST',
                    ...
                    success: function(response) {
                        showAlert('success', 'Activity and questions updated successfully',
                            'bxs-check-circle');
                        window.location.href = "<?php echo e(route('quizzes.index')); ?>";
                    },
                    error: function(response) {
            ...
            <?php $__currentLoopData = $quiz->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                addExistingQuestion(<?php echo json_encode($question, 15, 512) ?>, <?php echo e($index + 1); ?>);
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            function addExistingQuestion(question, index) {
                ...
                if (question.question_type === 'choice') {
                    ...
                    question.choices.forEach(function(choice, choiceIndex) {
                        addExistingChoice(questionElement, choice, choiceIndex < 2);
                    });
                } else {
                    questionElement.find('.multiple-choice-options').hide();
                    questionElement.find('.choices-container').empty();
            ...
            function addExistingChoice(questionElement, choice, isDefault) {
                var choiceTemplate = $('#choice-template').html();
                var choiceElement = $(choiceTemplate).clone();
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/dashboard/quiz/edit-quiz.blade.php ENDPATH**/ ?>