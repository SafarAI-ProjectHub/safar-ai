...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-body">
            <h5>Inactive Subscriptions List</h5>
            ...
            <div class="table-responsive">
                <table id="inactive-subscriptions-table" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th>User</th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#inactive-subscriptions-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('admin.inactive_subscriptions')); ?>',
                    data: function(d) {
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/dashboard/admin/subscriptions/inactive_subscriptions.blade.php ENDPATH**/ ?>