    ...
    <script>
        $(document).ready(function() {
            var table = $('#teachers-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('admin.getTeachersWithAssessments')); ?>',
                columns: [{
                        data: 'full_name',
                        name: 'full_name'
                    },
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/dashboard/admin/teacher_level_test_assessment.blade.php ENDPATH**/ ?>