                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="count-box">
                            ...
                            <div>
                                <span data-purecounter-start="0" data-purecounter-end="<?php echo e($totalStudents); ?>"
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="count-box">
                            ...
                            <div>
                                <span data-purecounter-start="0" data-purecounter-end="<?php echo e($totalCourses); ?>"
                                    data-purecounter-duration="1" class="purecounter"></span>
                                <p>Courses Offered</p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="count-box">
                            ...
                            <div>
                                <span data-purecounter-start="0" data-purecounter-end="<?php echo e($totalTeachers); ?>"
                                    data-purecounter-duration="1" class="purecounter"></span>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faq2-content-3" class="accordion-collapse collapse" data-bs-parent="#faqlist2">
                                    <div class="accordion-body">
                                        ...
                                        email at <a href="mailto:<?php echo e(env('Email_Adrees')); ?>"><?php echo e(env('Email_Adrees')); ?></a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="hero-slider owl-carousel owl-theme aos-init aos-animate" data-aos="fade-up">
                <?php $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="hero-slider-item"
                        style="background-image: url('<?php echo e(asset('storage/' . $offer->background_image)); ?>');">
                        <div class="container">
                            <div class="hero-content text-<?php echo e($offer->alignment); ?>">
                                <div class="section-heading">
                                    <h2 class="section__title text-white fs-65 lh-80 pb-3"><?php echo e($offer->title); ?></h2>
                                    <p class="section__desc text-white pb-4"><?php echo e($offer->description); ?></p>
                                </div><!-- end section-heading -->
                                <div
                                    class="hero-btn-box d-flex flex-wrap align-items-center pt-1 justify-content-<?php echo e($offer->alignment); ?>">
                                    <?php if($offer->action_type === 'link'): ?>
                                        <a href="<?php echo e($offer->action_value); ?>" class="btn theme-btn mr-4 mb-4">Join
                                            with Us <i class="la la-arrow-right icon ml-1"></i></a>
                                    <?php elseif($offer->action_type === 'email'): ?>
                                        <a href="mailto:<?php echo e($offer->action_value); ?>"
                        ...
                        <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <h4>Course:'<?php echo e($review->course->title); ?>'</h4>
                                    <div class="profile mt-auto">
                                        <img src="<?php echo e(asset($review->user->profile_image ? $review->user->profile_image : 'assets/images/avatars/profile-Img.png')); ?>"
                                            class="testimonial-img" alt="">
                                        <h4><?php echo e($timeDiff); ?></h4>
                                        <h3><?php echo e($review->user->full_name); ?></h3>
                            ...
                            <div class="swiper-slide">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="<?php echo e(asset($teacher->user->profile_image ?? 'assets/images/avatars/profile-Img.png')); ?>"
                                            class="img-fluid" alt="<?php echo e($teacher->user->full_name); ?>">

                                        <div class="social">
                                            <?php if($teacher->cv_link): ?>
                                                <a href="<?php echo e($teacher->cv_link); ?>" target="_blank"><i
                                    ...
                                    <div class="member-info">
                                        <h4><?php echo e($teacher->user->full_name); ?></h4>
                                        <p>Experience: <?php echo e($teacher->years_of_experience); ?> years</p>
                                    </div>
                                </div>
                            </div><!-- End member item -->
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <h3>Email Us</h3>
                                    <p>
                                        <a href="mailto:<?php echo e(env('Email_Adrees')); ?>" style="color: black; text-decoration: none;" 
                                        onmouseover="this.style.color='purple'" 
                                        onmouseout="this.style.color='black'">
                                            <?php echo e(env('Email_Adrees')); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/welcome.blade.php ENDPATH**/ ?>