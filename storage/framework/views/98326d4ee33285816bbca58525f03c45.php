    ...
    <script>
        $(document).ready(function() {
            var table = $('#students-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('admin.getStudentsWithAssessments')); ?>',
                columns: [{
                        data: 'full_name',
                        name: 'full_name'
                    },
                ...
                $.get('/admin/students/' + studentId + '/assessments', function(data) {
                    ...
                    data.assessments.forEach(function(assessment) {
                        ...
                        if (assessment.question && assessment.question.media_type ===
                            'audio') {
                            mediaContent =
                                `<audio controls style="margin-top:10px;"><source src="<?php echo e(asset('${assessment.question.media_url}')); ?>" type="audio/mpeg">Your browser does not support the audio element.</audio>`;
                        }
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/dashboard/admin/student_level_test_assessment.blade.php ENDPATH**/ ?>