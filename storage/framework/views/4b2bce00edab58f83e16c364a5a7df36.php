            ...
            $('#rate-table tbody').on('click', 'a.delete', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(route('rates.destroy', '')); ?>/" + id,
                            type: 'DELETE',
                            data: {
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/dashboard/admin/reviews.blade.php ENDPATH**/ ?>