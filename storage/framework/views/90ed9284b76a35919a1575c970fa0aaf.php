                    ...
                    <div class="col-md-4">
                        <select id="age-group-filter" class="form-control">
                            ...
                            <?php $__currentLoopData = $ageGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ageGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($ageGroup); ?>"><?php echo e($ageGroup); ?></option>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#youtube-videos-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('youtube_videos.index')); ?>',
                    data: function(d) {
            ...
            $('#addVideoForm').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: '<?php echo e(route('youtube_videos.store')); ?>',
                    method: 'POST',
                    data: $(this).serialize(),
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/dashboard/admin/youtube/index.blade.php ENDPATH**/ ?>