    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end mb-3">
                <a href="<?php echo e(route('teacherTest.addPage')); ?>" class="btn btn-sm btn-primary">Add New Test</a>
            </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#teacher-tests-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('teacherTests.datatable')); ?>',
                columns: [{
                        data: 'title',
                        name: 'title'
                    },
...
<?php echo $__env->make('layouts_dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/safar-ai-staging/resources/views/dashboard/level_test/teacher_tests.blade.php ENDPATH**/ ?>