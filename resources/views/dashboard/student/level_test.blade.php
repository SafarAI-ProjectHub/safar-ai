                ...
                <div class="question-body">
                    ...
                    @if($question->question_type === 'text')
                        ...
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-primary record-btn mb-3" data-target="audio-playback_{{ $loop->iteration }}">
                                Record <i class="fas fa-microphone"></i>
                            </button>
                        </div>
                        <input type="file" id="audio-upload_{{ $loop->iteration }}"  name="question_{{ $question->id }}_audio" style="display:none;" accept="audio/*" required>
                    ...
                    @elseif($question->question_type === 'choice')
                        ...
                        @foreach($question->choices as $choice)
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="radio" name="question_{{ $question->id }}" id="option_{{ $loop->index }}" value="{{ $choice->id }}" required>
