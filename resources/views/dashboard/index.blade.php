                    ...
                    <div class="col">
                        <div class="p-3">
                            ...
                            <small class="mb-0">Overall
                                Visitor
                                <span> <i class="bx bx-up-arrow-alt align-middle"></i>
                                    2.43%</span></small>
                        </div>
                    </div>
                    <div class="col">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-xl-4">
                            ...
                            <div class="mb-4">
                                <p class="mb-2">
                                    <i class="flag-icon flag-icon-ca me-1"></i>
                                    Canada
                            ...
                            <div class="mb-4">
                                <p class="mb-2">
                                    <i class="flag-icon flag-icon-au me-1"></i>
                                    Australia
                            ...
                            <div class="mb-4">
                                <p class="mb-2">
                                    <i class="flag-icon flag-icon-in me-1"></i>
                                    India
