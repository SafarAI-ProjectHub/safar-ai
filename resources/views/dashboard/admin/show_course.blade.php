            ...
            <div class="course-dashboard-container d-flex">
                <div class="course-dashboard-column">
                    @foreach ($course->units as $unit)
                        <div class="lecture-viewer-container {{ $loop->first ? '' : 'd-none' }}"
                            id="unit-content-{{ $unit->id }}">
                            <div class="lecture-video-item">
                                @if ($unit->content_type === 'video')
                                    <video controls crossorigin playsinline id="player-{{ $unit->id }}">
                                ...
                                @foreach ($course->units as $unit)
                                    <div class="card">
                                        <div class="card-header" id="heading-{{ $unit->id }}">
                                            <button class="btn btn-link unit-link" type="button"
                                                data-target="#unit-content-{{ $unit->id }}">
                                                <i class="la la-angle-down"></i>
                                                <i class="la la-angle-up"></i>
                                                <span class="fs-15"> {{ $unit->title }}</span>
                                            </button>
                                        </div>
                                                            ...
                                                            <div class="course-item-content">
                                                                ...
                                                                @if ($unit->content_type === 'video')
                                                                    <p class="course-item-meta"><i
                                                                            class="la la-play-circle"></i> Video</p>
                                                                @else
                                                                    <p class="course-item-meta"><i
                                                                            class="la la-file-text"></i> Text</p>
                                                                @endif
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.unit-link', function() {
                ...
                $('.lecture-viewer-container').addClass('d-none');
        ...
        @foreach ($course->units as $unit)
            @if ($unit->content_type === 'video')
                var player{{ $unit->id }} = new Plyr('#player-{{ $unit->id }}');
            @endif
        @endforeach
    </script>
@endsection --}}
            ...
            <div class="container-fluid">
                <div class="main-menu-content d-flex align-items-center">
                    ...
                    <div class="course-dashboard-header-title pl-4">
                        <a href="#" class="text-white fs-15">Course: {{ $course->title }}</a>
                                        ...
                                        <div class="lecture-overview-stats-wrap d-flex">
                                            ...
                                            <div class="lecture-overview-stats-item">
                                                <ul class="generic-list-item">
                                                    ...
                                                    <li><span>Age:</span>{{ $course->category->age_group }} years old
                                                    </li>
                                    ...
                                    <div class="lecture-overview-item">
                                        <div class="lecture-overview-stats-wrap d-flex">
                                            ...
                                            <div class="lecture-overview-stats-item lecture-overview-stats-wide-item">
                                                ...
                                                <a href="#" class="btn theme-btn theme-btn-transparent">Safar AI
                                                    Certificate</a>
                                            </div><!-- end lecture-overview-stats-item -->
                                        </div><!-- end lecture-overview-stats-wrap -->
                                    </div><!-- end lecture-overview-item -->
...
======================================-->
    ...
    <script>
        ...
        `;
                ...
                viewerContainer.innerHTML = `
            <div class="collapse lecture-viewer-text-wrap active">
                <div class="lecture-viewer-text-content custom-scrollbar-styled">
                    <div class="lecture-viewer-text-body">
                        ${content}
                    </div>
