                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            ...
                            if (errors.first_name) {
                                $("#first_name").next('.text-danger').text(errors.first_name[
                                    0]);
                            }
                            if (errors.last_name) {
                            ...
                            if (errors.phone_number) {
                                $("#phone_number").next('.text-danger').text(errors
                                    .phone_number[0]);
                            }
                            if (errors.date_of_birth) {
                                $("#date_of_birth").next('.text-danger').text(errors
                                    .date_of_birth[0]);
                            }
                            if (errors.password) {
