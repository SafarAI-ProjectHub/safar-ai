                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="country_location"
                                            class="form-control @error('country_location') is-invalid @enderror"
                                            value="{{ old('country_location', Auth::user()->country_location) }} "
                                            disabled />
                                        <input type="hidden" name="country_location"
                                            value="{{ old('country_location', Auth::user()->country_location) }}" />
