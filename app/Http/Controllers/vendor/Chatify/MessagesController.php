...
class MessagesController extends Controller
{
    ...
    public function fetch(Request $request)
    {
        ...
        if ($request->has('contract_id')) {
            // Fetch messages related to the contract
            $query = Message::where('contract_id', $request['contract_id'])->latest();
        } else {
            // Use the original functionality to fetch messages
        ...
        foreach ($messages->reverse() as $message) {
            ...
            if (Auth::user()->hasRole('Admin|Super Admin')) {
                ...
                if ($user->hasRole('Admin') || $user->hasRole('Super Admin')) {
                    ...
                    $parsedMessage['isSender'] = true;  // Make it look like the admin is the sender
                    $allMessages .= Chatify::messageCard($parsedMessage);
                } else {
